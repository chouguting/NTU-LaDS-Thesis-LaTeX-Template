...
%插入審定書的pdf檔
\includepdf[pages={1}]{front/acceptance_certificate.pdf}


\pagenumbering{roman} % 頁碼從致謝開始（羅馬數字）
...
% 論文內容
% Contents of Thesis
\cleardoublepage                  % 章節從下一個偶數頁開始 (如果是openany則沒有影響)
\pagenumbering{arabic}            % 主文頁碼從 1 開始
\mainmatter
